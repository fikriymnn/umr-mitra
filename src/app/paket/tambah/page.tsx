...
function DetailPaket() {
  ...
  const handleFileChange = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onload = () => {
        ...
        setNewImage(""); // Clear the input after adding the image
      };
  ...
  const [jadwal, setJadwal] = useState([{ hari: "", agenda: "" }]);
    ...
    <div className="flex ">
      ...
      <div className="h-screen w-screen yellow px-[28px] py-[20px] overflow-y-scroll">
        ...
        <div className="bg-white rounded-[10px] w-full mt-[20px] p-5">
          ...
          <div className="pt-5">
            <button className="w-full font-semibold text-xl rounded-md p-3 text-semibold text-white bg-[#E3B02B] hover:bg-[#b18a2a]">
              Tambahkan Paket
            </button>
          </div>
        </div>
