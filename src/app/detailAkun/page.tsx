        ...
        <div className='flex'>
            ...
            <div className='h-screen w-screen bg-[#E3B02B] px-[28px] py-[20px]  overflow-y-scroll' >
                <div>
                    ...
                    <div className='flex '>
                        <div className='flex flex-col bg-white w-[320px] h-[660px] shadow-xl rounded-lg px-8 pt-6 pb-8 mb-4 mt-[20px]'>
                        ...
                        <div className='flex flex-col bg-white w-[894px] h-[660px] shadow-xl rounded-lg px-20 pt-12 pb-12 mt-[20px] ml-[29px]'>
                            ...
                            <div className='grid grid-cols-2'>
                                ...
                                <div>
                                    <button className="w-44 h-8 ml-[200px] bg-amber-400 rounded-md text-center text-white text-xl font-normal">
